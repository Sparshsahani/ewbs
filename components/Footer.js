...
export default function Footer() {
  ...
  return (
    <footer
      data-aos="fade-up"
      className="relative  text-gray-600 pt-16 pb-8 text-sm overflow-hidden border-t"
    >
        ...
        <div className="flex flex-col lg:flex-row justify-between gap-10">
          ...
          <div className="lg:w-1/2 space-y-6">
            ...
            <div className="mb-8">
              ...
              <p className="text-xs font-semibold uppercase tracking-wider text-gray-500 border-b pb-4 border-gray-300 w-full max-w-md">
                EWBS STAR BUSINESSMEN SERVICES LLC
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="border-b border-gray-300 pb-4 max-w-md space-y-2">
                <p className="leading-relaxed text-gray-500">
                  Office 903, 9th floor, Aspin Commercial Tower, Shaikh Zayed
                  Road, Dubai, UAE
                </p>
                <p className="font-medium text-gray-700">
                  Contact : +971 42 559 901
                </p>
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="border-b border-gray-300 pb-4 max-w-md space-y-2">
                <p className="leading-relaxed text-gray-500">
                  Street name : Steintorweg
                  <br />
                  Building no : 8<br />
                  Zipcode : 20099
                </p>
                <p className="font-medium text-gray-700">
                  Contact : +49 163 9844453
                </p>
              </div>
            </div>
            ...
            {/* India Offices — hidden in Pakistan */}
            {countryCode !== "PK" && (
              <>
                <div className="space-y-2">
                  <h3 className="font-semibold text-gray-800 text-base">
                  ...
                  <div className="border-b border-gray-300 pb-4 max-w-md space-y-2">
                    <p className="leading-relaxed text-gray-500">
                      MGF Megacity Mall, Unit No.1, MG Road,
                      <br />A Block, DLF Phase-1, Sector 28.
                    </p>
                  </div>
                </div>
                <div className="space-y-2">
                  <h3 className="font-semibold text-gray-800 text-base">
                    India Office Lucknow
                  </h3>
                  <div className="border-b border-gray-300 pb-4 max-w-md space-y-2">
                    <p className="leading-relaxed text-gray-500">
                      11th Floor, Wing A, Summit Building
                      <br />
                      Vibhti khand, Gomti Nagar, Lucknow
                    </p>
                    <p className="font-medium text-gray-700">
            ...
            {/* Pakistan Office — only visible in Pakistan */}
            {countryCode === "PK" && (
              <div className="space-y-2">
                <h3 className="font-semibold text-gray-800 text-base">
                  Pakistan Office
          ...
          <div className="lg:w-1/2 flex flex-col md:flex-row lg:justify-end gap-10 lg:gap-24 text-left md:text-right mt-10 lg:mt-0">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-3 text-gray-500">
                <Link
                  href="/"
                  className="hover:text-[var(--bg-red)] transition-colors"
                >
                  Home
                </Link>
                <Link
                ...
                <Link
                  href="/business-setup-services-in-dubai"
                  className="hover:text-[var(--bg-red)] transition-colors"
                >
                  Our Services
                </Link>
            ...
            {/* Other Links */}
            <div className="flex flex-col gap-4">
              <h4 className="text-[var(--bg-red)] font-bold text-lg">
                Other Links
              </h4>
              <div className="flex flex-col gap-3 text-gray-500">
                <Link
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-3 text-gray-500">
                <Link
                  href="/dubai-free-zone-business-setup"
                  className="hover:text-[var(--bg-red)] transition-colors"
                >
                  Dubai Freezone
                </Link>
